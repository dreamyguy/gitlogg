...
echo -e "${Yel}Path is set to ${Red}${yourpath}${Yel}...${RCol}"

SECONDS=0

echo -e "${Yel}Initializing git log generation...${RCol}"
...
echo -e "${Gre}The file ${Red}./gitlogg.tmp ${Gre}generated in${RCol}: ${SECONDS}s"
